...
// Test 1: Can we update the debug element?
setTimeout(function() {
    var debugElement = document.getElementById('debug-info');
    if (debugElement) {
        debugElement.textContent = 'SUCCESS: Bundle.js executed!';
        debugElement.style.color = 'green';
        debugElement.style.fontWeight = 'bold';
        console.log('SUCCESS: Debug element updated');
    } else {
        console.log('ERROR: Debug element not found');
    }
}, 100);
